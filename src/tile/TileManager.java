...
public class TileManager {
    ...
    public void setup(int i, String imageName, boolean collision) {
        ...
        try {
            ...
            tiles[i] = new Tile();
            tiles[i].image = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/tiles/" + imageName + ".png")));
            uTool.scaledImage(tiles[i].image, gp.tileSize, gp.tileSize);
